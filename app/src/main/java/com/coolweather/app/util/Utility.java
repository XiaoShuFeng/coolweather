...
public class Utility {
    ...
    public static void handleWeatherResponse(Context contex, String response){
        try{
            ...
            saveWeatherInfo(contex,cityName,weatherCode,temp1,temp2,
    ...
    public static void saveWeatherInfo(Context contex,String cityName,
           String weatherCode,String temp1,String temp2,String weatherDesp,
           String publishTime){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy年M月d日",
                Locale.CHINA);
        SharedPreferences.Editor editor = PreferenceManager
                .getDefaultSharedPreferences(contex).edit();
